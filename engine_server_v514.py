"""揭棋引擎服务 - v5.14 基线 (main: make/unmake 重构 + P0 暗子池 + 风险惩罚默认关)。

与 engine_server.py 同协议, 仅加载 jieqi_engine_v514 (main 版本) 用于配对对照。
"""
...
def main(engine_module="jieqi_engine_v514"):
    ...
    _log(f"[engine_server_v514] 就绪 ({runtime} {sys.version.split()[0]}, "
    ...
    try:
        ...
        _log("[engine_server_v514] 预热完成")
    except Exception as e:
        _log(f"[engine_server_v514] 预热跳过: {e}")
